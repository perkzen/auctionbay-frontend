...
import NavigationTabs from '@/components/composites/navbar/navigation-tabs';
import NavbarUserActions from '@/components/composites/navbar/navbar-user-actions';
import NavbarAuthActions from '@/components/composites/navbar/navbar-auth-actions';

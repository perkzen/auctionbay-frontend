...
import AuctionStatusTag from '@/components/composites/auctions/auction-status-tag';
import TimeTag from '@/components/ui/time-tag';
import { AuctionStatus } from '@/libs/types/auction';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs';
import CreateBidForm from '@/components/composites/auctions/create-bid-form';
import CreateAutoBidForm from '@/components/composites/auctions/create-auto-bid-form';
